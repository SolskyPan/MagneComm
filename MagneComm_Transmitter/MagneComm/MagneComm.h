...
#define HIGH_SPEED_SYMBOL_TIME_LENGTH 100000 // us
#define HIGH_SPEED_SYMBOL_TIME_LENGTH_MS 200


#define HIGH_SPEED_PACKAGE_TOTAL_BIT_NUM 2040
#define HIGH_SPEED_PACKAGE_SYMBOL_NUM  2040 // on-off-key
...
public:
	...
	pwam_symbol_struct* HighSpeedModulateData2(int* package_data);
